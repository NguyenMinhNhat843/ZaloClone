...
const AddViceLeaderModal = ({ members, onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-[480px] max-w-full shadow-lg">
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-lg font-semibold">Điều chỉnh phó nhóm</h2>
        ...
        <div className="px-4 max-h-60 overflow-y-auto space-y-2">
          ...
          {filteredMembers.length === 0 && (
            <p className="text-sm text-gray-500 px-2 py-4">Không tìm thấy thành viên phù hợp.</p>
          )}
        </div>
...
export default AddViceLeaderModal;
